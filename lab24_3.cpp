...
/// @brief This function is count distinct value of data.
/// @param data is int array 
/// @param number is int number of arrray
/// @return จำนวนตัวที่ไม่ซ้ำกันใน data array
